"""
SA NN training on HR data (Feature selection complete)
...
def train(oa, network, oaName, training_ints,validation_ints,testing_ints, measure):
    ...
    for iteration in xrange(TRAINING_ITERATIONS):
        ...
        if iteration % 10 == 0:
            ...
            with open("/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/" + OUTFILE.replace('XXX',oaName),'a+') as f:
                f.write(txt)
...
def main(CE):
    ...
    with open("/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/" + OUTFILE.replace('XXX',oa_name),'w') as f:
