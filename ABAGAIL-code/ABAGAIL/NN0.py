"""
Backprop NN training on HR Data
...
import time
import sys
sys.path.append("/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/CS-7641-assignment-2-master/ABAGAIL/ABAGAIL.jar")
...
# Config File Path
PATH = "/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/HR_Data/"
...
# Column titles
# satisfaction_level	last_evaluation	number_project	average_montly_hours	time_spend_company	Work_accident	promotion_last_5years	sales_IT	sales_RandD	sales_accounting	sales_hr	sales_management	sales_marketing	sales_product_mng	sales_sales	sales_support	sales_technical	salary_high	salary_low	salary_medium	left
...
def train(oa, network, oaName, training_ints,validation_ints,testing_ints, measure):
    ...
    for iteration in xrange(TRAINING_ITERATIONS):
        ...
        if iteration % 10 == 0:
            ...
            with open("/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/" + OUTFILE,'a+') as f:
                f.write(txt)


def main():
    """Run this experiment"""
    training_ints = initialize_instances(PATH+'HR_train_data.csv')
    testing_ints = initialize_instances(PATH+'HR_test_data.csv')
    validation_ints = initialize_instances(PATH+'HR_valid_data.csv')
...
if __name__ == "__main__":
    with open("/Users/shuyi/Documents/OMSCS-master/MachineLearning/HW2/" + OUTFILE,'w') as f:
